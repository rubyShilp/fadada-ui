<script>
  ...
  export default {
    ...
    render(h) {
      ...
      const menus = this._l(activeOptions, (menu, menuIndex) => {
        ...
        const items = this._l(menu, item => {
          ...
          return (
            <li
              class={{
                'fa-cascader-menu__item': true,
                'fa-cascader-menu__item--extensible': item.children,
        ...
        return (
          <ul
            class={{
              'fa-cascader-menu': true,
              'fa-cascader-menu--flexible': isFlat
            }}
            {...hoverMenuEvent}
            style={menuStyle}
            refInFor
      ...
      return (
        <transition name="fa-zoom-in-top" on-before-enter={this.handleMenuEnter} on-after-leave={this.handleMenuLeave}>
          <div
            v-show={visible}
            class={[
              'fa-cascader-menus fa-popper',
              popperClass
            ]}
            ref="wrapper"
          >
